...
#                 'AutoARIMA': self.val_tran_autoarima
    ...
    def val_raw_lsvr(self, policy, series, n_val, retrain_window, split, horizon, score) -> Tuple[List]:
        raw_val_errs = []
    ...
    def val_tran_lsvr(self, policy, series, n_val, retrain_window, split, horizon, score) -> Tuple[List]:
        tran_val_errs = []
    ...
    def val_raw_mlp(self, policy, series, n_val, retrain_window, split, horizon, score) -> Tuple[List]:
    ...
    def val_tran_mlp(self, policy, series, n_val, retrain_window, split, horizon, score) -> Tuple[List]:
    ...
    def val_raw_en(self, policy, series, n_val, retrain_window, split, horizon, score) -> Tuple[List]:
    ...
    def val_tran_en(self, policy, series, n_val, retrain_window, split, horizon, score) -> Tuple[List]:
    ...
    def val_raw_rf(self, policy, series, n_val, retrain_window, split, horizon, score) -> Tuple[List]:
    ...
    def val_tran_rf(self, policy, series, n_val, retrain_window, split, horizon, score) -> Tuple[List]:
